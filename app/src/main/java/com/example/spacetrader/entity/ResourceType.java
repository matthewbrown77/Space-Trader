...
public enum ResourceType implements Serializable {
    ...
    DESERT("Desert", Color.rgb(204,136,0)),
    LOTS_OF_WATER("Lots of Water", Color.BLUE),
    RICH_SOIL("Rich Soil", Color.rgb(0,128,0)),
    POOR_SOIL("Poor Soil", Color.rgb(235,162,17)),
    RICH_FAUNA("Rich Fauna", Color.rgb(0,153,77) ),
    LIFELESS("Lifeless", Color.rgb(154,112,71)),
    WEIRD_MUSHROOMS("Weird Mushrooms", Color.rgb(179, 0, 30) ),
    LOTS_OF_HERBS("Lots of Herbs", Color.rgb(76,230,0)),
